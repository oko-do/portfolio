...
Redesigned the main editor interface with support for 2D and 3D molecular visualization, periodic table integration, compound search, and a template library for functional groups.
...
![Peptide Editor: a separate product built on the same design system](/images/cases/ketcher/default-layout.png)
